...
def FER_live_cam():
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            net.setInput(cv2.dnn.blobFromImage(rect, 1 / IMAGE_STD, (width, height), 127))
            ...
            for (x1, y1, x2, y2) in boxes:
                ...
                cv2.putText(frame, pred, (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2, lineType=cv2.LINE_AA)
                result.write(frame)
...
# Run the emotion recognition live camera function
FER_live_cam()
